...
const displayWord = (words)=> {
    ...
    <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md hover:bg-blue-50 object-cover">
            ...
            <div class="flex justify-between items-center">
                ...
                <button onclick="pronounceWord('${data.word}')"  class="bg-blue-100 hover:bg-blue-200 rounded-full p-3 transition-colors duration-200 hover:cursor-pointer">
                    <svg class="w-6 h-6 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
 ...
 function pronounceWord(wordz) {
      const utterance = new SpeechSynthesisUtterance(wordz);
